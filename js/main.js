...
function initailStores() {
	...
	_markerBicCamera = [
		makeMarker({
			...
			LatLng : new google.maps.LatLng(35.170325, 136.879417),
			iconColor : '',
			iconUrl : 'http://www.biccamera.co.jp/shoplist/img/icon/gm-marker-bic.png',
			title: 'ビックカメラ - 名古屋駅西店',
			infoCss: 'alert alert-danger',
			infoContent : '<div>ビックカメラ名古屋駅西店<p>〒453-0015 愛知県名古屋市中村区椿町6−9</p></div>'
		})
	];
	...
	_markerDonki = [
		makeMarker({
			mid: 'markerDonki001',
			LatLng : new google.maps.LatLng(35.148419, 136.891878),
			iconColor : '',
			iconUrl : 'http://www.donki.com/img/search/icn_store_donki2.png',
			title: '激安の殿堂 - パウ中川山王店',
			infoCss: 'alert alert-warning',
			infoContent : '<div>激安の殿堂 - パウ中川山王店<p>〒454-0011 愛知県名古屋市中川区山王4-5-5</p></div>'
		}),
		makeMarker({
			mid: 'markerDonki002',
			LatLng : new google.maps.LatLng(35.079253, 136.976152),
			iconColor : '',
			iconUrl : 'http://www.donki.com/img/search/icn_store_donki2.png',
			title: '激安の殿堂 - 緑店',
			infoCss: 'alert alert-warning',
			infoContent : '<div>激安の殿堂 - 緑店<p>〒458-0025 愛知県名古屋市緑区鳥澄1丁目401番地</p></div>'
		}),
		makeMarker({
			mid: 'markerDonki003',
			LatLng : new google.maps.LatLng(35.170246, 136.906408),
			iconColor : '',
			iconUrl : 'http://www.donki.com/img/search/icn_store_donki2.png',
			title: '激安の殿堂 - 名古屋栄店',
			infoCss: 'alert alert-warning',
			infoContent : '<div>激安の殿堂 - 名古屋栄店<p>〒460-0003 愛知県愛知県名古屋市中区錦3-17-15</p></div>'
		}),
		makeMarker({
			mid: 'markerDonki004',
			LatLng : new google.maps.LatLng(35.226491, 136.909007),
			iconColor : '',
			iconUrl : 'http://www.donki.com/img/search/icn_store_donki2.png',
			title: '激安の殿堂 - 名古屋本店',
			infoCss: 'alert alert-warning',
			infoContent : '<div>激安の殿堂 - 名古屋本店<p>〒462-0018 愛知県名古屋市北区玄馬町234-1</p></div>'
		}),
		makeMarker({
			mid: 'markerDonki005',
			LatLng : new google.maps.LatLng(35.168393, 136.937206),
			iconColor : '',
			iconUrl : 'http://www.donki.com/img/search/icn_store_donki2.png',
			title: '激安の殿堂 - 名古屋今池店',
			infoCss: 'alert alert-warning',
			infoContent : '<div>激安の殿堂 - 名古屋今池店<p>〒464-0850 愛知県名古屋市千種区今池5-10-1</p></div>'
		}),
		makeMarker({
			mid: 'markerDonki006',
			LatLng : new google.maps.LatLng(35.239840, 136.848741),
			iconColor : '',
			iconUrl : 'http://www.donki.com/img/search/icn_store_donki2.png',
			title: '激安の殿堂 - 楽市街道名古屋店',
			infoCss: 'alert alert-warning',
			infoContent : '<div>激安の殿堂 - 楽市街道名古屋店<p>〒481-0045 愛知県北名古屋市中之郷神明45-1</p></div>'
		}),
		makeMarker({
			mid: 'markerDonki007',
			LatLng : new google.maps.LatLng(36.596534, 136.638832),
			iconColor : '',
			iconUrl : 'http://www.donki.com/img/search/icn_store_donki2.png',
			title: '激安の殿堂 - パウ金沢店',
			infoCss: 'alert alert-warning',
			infoContent : '<div>激安の殿堂 - パウ金沢店<p>〒920-0064 石川県金沢市南新保町ニ16-1</p></div>'
		}),
		makeMarker({
			mid: 'markerDonki008',
			LatLng : new google.maps.LatLng(36.550633, 136.632013),
			iconColor : '',
			iconUrl : 'http://www.donki.com/img/search/icn_store_mega.gif',
			title: '激安の殿堂 - MEGAドン・キホーテ ラパーク金沢店',
			infoCss: 'alert alert-warning',
			infoContent : '<div>激安の殿堂 - MEGAドン・キホーテ ラパーク金沢店<p>〒921-8043 石川県金沢市西泉4-11</p></div>'
		}),
		makeMarker({
			mid: 'markerDonki008',
			LatLng : new google.maps.LatLng(36.550633, 136.632013),
	...
	_markerOasis21 = [
		makeMarker({
			...
			LatLng : new google.maps.LatLng(35.170923, 136.909673),
			iconColor : '',
			iconUrl : 'http://www.sakaepark.co.jp/access/img/icon-Gmap2.png',
			title: '宇宙船綠洲21(Oasis 21)',
			infoCss: 'alert alert-info',
			infoContent : '<div>宇宙船綠洲21(Oasis 21)<p>〒461-0005 愛知県名古屋市東区東桜一丁目11番1号</p></div>'
		})
	];
    ...
    _markerAppleStore = [
		makeMarker({
			...
			LatLng : new google.maps.LatLng(35.165490, 136.907061),
			iconColor : '',
			iconUrl : 'http://images.apple.com/mac/home/images/buystrip_app_large.jpg',
			title: 'Apple Store - 名古屋栄',
			infoCss: 'alert alert-info',
			infoContent : '<div>Apple Store - 名古屋栄<p>〒460-0008 愛知県名古屋市中区栄3-17-15</p></div>'
		})
	];
	...
	_markerMatsukiyo = [
		makeMarker({
			...
			title: '松本清 - 栄スカイル店',
			infoCss: 'alert alert-info',
			infoContent : '<div>松本清 - 栄スカイル店<p>〒460-0008 愛知県名古屋市中区栄3-4-5 栄スカイルB2F</p></div>'
		}),
		makeMarker({
			mid: 'markerMatsukiyo002',
			LatLng : new google.maps.LatLng(35.168377, 136.895072),
			iconColor : '',
			iconUrl : 'http://www.e-map.ne.jp/cgi/icon_select.cgi?cid=matukiyo&icon_id=1&dummy=1427218476084.gif',
			title: '松本清 - 広小路伏見店',
			infoCss: 'alert alert-info',
			infoContent : '<div>松本清 - 広小路伏見店<p>〒460-0003 愛知県名古屋市中区栄3-4-5 栄スカイルB2F</p></div>'
		}),
		makeMarker({
			...
			title: '松本清 - ミヤコ地下街店',
			infoCss: 'alert alert-info',
			infoContent : '<div>松本清 - ミヤコ地下街店<p>〒450-0002 愛知県名古屋市中村区名駅4丁目9番10号</p></div>'
		}),
		makeMarker({
			...
			title: '松本清 - 名古屋駅太閤通口店',
			infoCss: 'alert alert-info',
			infoContent : '<div>松本清 - 名古屋駅太閤通口店<p>〒450-0002 愛知県名古屋市中村区名駅1-1-4</p></div>'
		}),
		makeMarker({
			...
			title: '松本清 - 金沢駅西口店',
			infoCss: 'alert alert-info',
			infoContent : '<div>松本清 - 金沢駅西口店<p>〒920-0858 石川県金沢市木ノ新保町1-1　金沢百番街くつろぎ館2階</p></div>'
		}),
		makeMarker({
			...
			infoCss: 'alert alert-info',
			infoContent : '<div>松本清 - アピタタウン金沢ベイ店<p>〒920-0333 石川県金沢市無量寺4-56</p></div>'
		})
	];
    ...
    _markerZeroGate = [
		makeMarker({
			mid: 'markerAppleStore001',
			LatLng : new google.maps.LatLng(35.164160, 136.906888),
			iconColor : '',
			iconUrl : 'http://www.parco.co.jp/img/common/header-logo.png',
			title: 'ZERO GATE - 名古屋',
			infoCss: 'alert alert-info',
			infoContent : '<div>ZERO GATE - 名古屋<p>〒460-0008 愛知県名古屋市中区栄3-28-11</p></div>'
		})
	];
}
